...
import uuid
import matplotlib
from plotwordcloud import generate_words
import time
...
APP_ACCESS_TOKEN = 'provide your app access token here'
...
def start_bot():
    while True:
        ...
        print "k.Plot a graph of the tags of the user "
        print "l.Exit"

# choices and action to be taken corresponding to them.
        ...
        if choice == "a":
            ...
            exit()
    else:                # default message is printed here.
        print "wrong choice"
start_bot()